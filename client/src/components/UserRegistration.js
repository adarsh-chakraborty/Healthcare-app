  ...
  return (
    <>
      ...
      <div className="container2">
        {' '}
        <h1 class="pt-1 heading"> User Registration </h1>
        <hr
          style={{
            width: '20%',
      ...
      {signedUp ? (
        <p style={{ textAlign: 'center' }}>
          Sign up successful, Please login <a href="/loginUi">here</a>
        </p>
      ) : (
              ...
              <div className="signup-form">
                {error.length == 0
                  ...
                  : error.map((key, value) => (
                      ...
                      >
                        <i class="zmdi zmdi-close-circle material-icons-name mr-2"></i>
                        {key.msg}
                      </p>
                    ))}
