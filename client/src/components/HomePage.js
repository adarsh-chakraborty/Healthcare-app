  ...
  return (
    <>
      ...
      <div class="LandingContainer">
        <div class="Text">
          <h1>
            One Stop for all <br></br> your Medical needs
          </h1>
          <p>
            {' '}
        ...
        <div className="cardContainer">
          <div className="card">
            ...
            <h5
              ...
              className="heading"
            >
              Summarised Report of Symptoms and Treatment
            </h5>
            <p>
              {' '}
              To receive a summarised report of your problem and possible
              treatment after answering a few questions based on the
              symptoms,use this feature. This report can be extremely helpful to
              the doctors as they will be aware of patient’s condition and can
          ...
          <div className="card">
            ...
            <h5
              ...
              className="heading"
            >
              Multiple Quick Diagnosis
            </h5>
            <p>
              In India we have a huge population with chronic conditions like
